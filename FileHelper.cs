...
namespace Utility {
	...
	public static class FileHelper {
		...
		public static List<string> loadPlace(string fileName) {
			...
			string path = "assets/main/places/" + fileName + ".txt";
			string buffer;
		...
		public static List<string> loadGraphic(string fileName) {

			string path = "assets/graphics/" + fileName + ".txt";
			string buffer;
			List<string> file = new List<string>();
		...
		public static List<string> loadDescription(string fileName) {

			string path = "assets/descriptions/" + fileName + ".txt";
			string buffer;
			List<string> file = new List<string>();
